...
<!-- <link href=" history.php" rel="stylesheet" type="text/css"> -->
...
<!-- USER PROFILE BLOCK -->
  <div class="col-sm-3 col-lg-3">
        <div class="dash-unit">
            ...
            <hr>
          <div class="thumbnail">
              <img src="assets/img/IMG_Profile/Perfil1.png" alt="Marcel Newman" class="img-circle">
          </div><!-- /thumbnail -->
          <h1>Juan Contreras</h1>
          <h3>Puebla, Pue.</h3>
          <br>
              <div class="info-user">
...
<!-- DONUT CHART BLOCK -->
  <div class="col-sm-3 col-lg-3">
        <div class="dash-unit">
            <dtitle> summary of purchases per month</dtitle>
            <hr>
          <div id="load"></div>
          <h2>45%</h2>
      </div>
...
<!-- LAST MONTH REVENUE -->     
  <div class="col-sm-3 col-lg-3">
        <div class="dash-unit">
            ...
            <hr>
            <div class="cont">
              <p><bold>$35,000</bold> | <ok>Approved</ok></p>
              <br>
              <p><bold>$20,000</bold> | Pending</p>
              <br>
              <p><bold>$10,000</bold> | <bad>Denied</bad></p>
              <br>
...
<!-- 30 DAYS STATS - CAROUSEL FLEXSLIDER -->     
  <div class="col-sm-3 col-lg-3">
        <div class="dash-unit">
            <dtitle>last purchase made </dtitle>
            <hr>
            <br>
            <br>
          <div class="flexslider">
              <ul class="slides">
                  <li><img src="assets/img/Compra.png " alt="slider"></li>
              </ul>
      </div>
          <div class="cont">
